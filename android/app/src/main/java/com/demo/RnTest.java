...
public class RnTest extends ReactContextBaseJavaModule {
    ...
    public void getResult(Callback locationCallback) {
        this.locationCallback = locationCallback;
        //初始化client
        locationClient = new AMapLocationClient(this.getReactApplicationContext());
        ...
        startLocation();
      //  locationCallback.invoke("  success");
    }
    /**
     * 默认的定位参数
     * @since 2.8.0
